...
urlpatterns = [
    ...
    path('produccion/equipos/json/', views.EquipoJsonList.as_view(), name='json_equipo_list'),
    path('produccion/equipos/json/<int:pk>/', views.EquipoJsonDetail.as_view(), name='json_equipo_detail'),
