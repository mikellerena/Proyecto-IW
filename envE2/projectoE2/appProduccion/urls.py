...
urlpatterns = [
    ...
    path('produccion/equipos/api/', views.EquipoJsonList.as_view(), name='api_equipo_list'),
    path('produccion/equipos/api/<int:pk>/', views.EquipoJsonDetail.as_view(), name='api_equipo_detail'),
