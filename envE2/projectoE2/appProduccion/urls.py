...
urlpatterns = [
    ...
    path('editarempleado/<str:pk>/', views.EmpleadoUpdateView.as_view(), name='empleado_edit'),
    path('borrarempleado/<str:pk>/', views.EmpleadoDeleteView.as_view(), name='empleado_delete'),
    ...
    path('editarproceso/<str:pk>/', views.ProcesoUpdateView.as_view(), name='proceso_edit'),
    path('borrarproceso/<str:pk>/', views.ProcesoDeleteView.as_view(), name='proceso_delete'),
]
